...
if __name__ == "__main__":
    ...
    image_ids = open(os.path.join(VOCdevkit_path, "CUB_VOC_aug/ImageSets/Main/test.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            image_path  = os.path.join(VOCdevkit_path, "CUB_VOC_aug/JPEGImages/"+image_id+".jpg")
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        for image_id in tqdm(image_ids):
            with open(os.path.join(map_out_path, "ground-truth/"+image_id+".txt"), "w") as new_f:
                root = ET.parse(os.path.join(VOCdevkit_path, "CUB_VOC_aug/Annotations/"+image_id+".xml")).getroot()
